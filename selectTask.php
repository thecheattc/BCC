...
<script type="text/javascript" 
	...
	?>
<head>
<title>Bryant Food Distribution Task Select</title>
</head>
	<body>
		<div id="header">
		...
		<div id="taskWrap">
			<div class="task">
				...
				<img src="images/addClient.jpg" alt="Click this area to add new client information" />
				<p>Click here to add a new client to the database</p></a>
			</div>
			<div class="task">
				<a href="">
				<h3>Manage Food Distribution</h3>
				<img src="images/foodDist.png" alt="Click this area to check the date of a client's last visit" />
